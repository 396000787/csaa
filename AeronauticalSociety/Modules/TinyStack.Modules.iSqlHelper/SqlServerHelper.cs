...
namespace TinyStack.Modules.iSqlHelper
{
    ...
    public class SqlServerHelper
    {
        ...
        public static readonly string connectionString = "";//ConfigurationManager.ConnectionStrings["testConnectionString"].ConnectionString;
        ...
        /// <summary>
        /// 枚举,标识数据库连接是由SqlServerHelper提供还是由调用者提供
        /// </summary>
        private enum SqlConnectionOwnership
        {
            /// <summary>由SqlServerHelper提供连接</summary>
            Internal,
        ...
        /// <remarks>
        /// 示例:
        /// FillDataset(conn, CommandType.StoredProcedure, "GetOrders", ds, new string[] {"orders"}, newSqlParameter("@prodid", 24));
        /// </remarks>
        /// <param name="connection">一个有效的数据库连接对象</param>
        /// <param name="commandType">命令类型 (存储过程,命令文本或其它)</param>
        /// <param name="commandText">存储过程名称或T-SQL语句</param>
        ...
        public static bool ExecuteNonQuery(SqlConnection connection, List<string> SqlTexts, List<SqlParameter[]> commandParameters, bool IsTransaction)
        {
            if (connection == null) throw new ArgumentNullException("connection");
            bool mustCloseConnection = false;
            if (connection.State != ConnectionState.Open)
