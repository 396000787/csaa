    ...
    {  
       ...
       /// </summary>
        ...
        public int ExecuteNonQuery(string cmdText, params MySqlParameter[] cmdParms)
        {
            ...
            return _MySQLHelper.ExecuteNonQuery(ConnectionString, System.Data.CommandType.Text, cmdText, cmdParms);
        }
        #endregion
        ...
        public List<T> ExecuteQuery<T>(string cmdText, params MySqlParameter[] cmdParms)
        {
            ...
            //执行sql语句
            MySQLHelper _MySQLHelper = new MySQLHelper();
            DataSet returnData = _MySQLHelper.ExecuteDataset(ConnectionString, System.Data.CommandType.Text, cmdText, cmdParms);
