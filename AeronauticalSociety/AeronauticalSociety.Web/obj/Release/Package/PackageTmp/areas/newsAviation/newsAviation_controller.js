// 引导页功能
console.log(angular);
angular.module('newsAviation.controller', ['newsAviation.service'])
  .controller('newsAviation', function ($scope, $stateParams, newsAviationFty, $location, $window, $ionicLoading) {
      $scope.NewsListData = [];
      $scope.pageSize = 10;
      $scope.pageNum = 0;
      ...
      $scope.func_refreshGoodsList = function () {
          $scope.pageNum = 0;
          newsAviationFty.GetNewsListData({ StartRow: $scope.pageNum * $scope.pageSize, PageSize: $scope.pageSize }, function (msg) {
